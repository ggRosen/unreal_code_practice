...
#include "cpp_practice/SCharacter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	CPP_PRACTICE_API UClass* Z_Construct_UClass_ASCharacter_NoRegister();
	CPP_PRACTICE_API UClass* Z_Construct_UClass_ASCharacter();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASCharacter_Statics::NewProp_CameraComp_MetaData[] = {
		{ "Category", "SCharacter" },
		{ "Comment", "//??????\xd2\xaa????\xd2\xbb??????\xd2\xbb????\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "SCharacter.h" },
		{ "ToolTip", "??????\xd2\xaa????\xd2\xbb??????\xd2\xbb????" },
	};
#endif
	...
	IMPLEMENT_CLASS(ASCharacter, 1239941693);
	template<> CPP_PRACTICE_API UClass* StaticClass<ASCharacter>()
	{
		return ASCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASCharacter(Z_Construct_UClass_ASCharacter, &ASCharacter::StaticClass, TEXT("/Script/cpp_practice"), TEXT("ASCharacter"), false, nullptr, nullptr, nullptr);
