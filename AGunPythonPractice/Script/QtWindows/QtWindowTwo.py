...
class QtWindowTwo(QtWidgets.QWidget):
	...
	def myTick(self, delta_seconds):
		...
		if self.random_actor:
			speed = 360.0 * delta_seconds
			self.random_actor.add_actor_world_rotation(unreal.Rotator(0.0, 0.0, speed), False, False) # 按照一定的程度旋转